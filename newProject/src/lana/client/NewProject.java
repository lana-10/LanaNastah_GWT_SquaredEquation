...
public class NewProject implements EntryPoint {
	...
	//	nameField.setText("GWT User");
		...
		RootPanel.get("errorLabelContainer1").add(errorLabel1);
	...
	//	nameField2.setFocus(false);
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			 ...
			 */
			String name1 = String.valueOf(nameField1.getText());
			String name2 = String.valueOf(nameField2.getText());
			String name3 = String.valueOf(nameField3.getText());
			String textToServer1 = name1.toString() + "&" +name2.toString() + "&" +name3.toString();
		
			private void sendNameToServer() {
				// First, we validate the input.
				errorLabel1.setText("");
				if (!FieldVerifier.isValid(Integer.parseInt(nameField1.getText().toString()))) {
					errorLabel1.setText("a musn't be 0");
					return;
				}
				...
				greetingService.greetServer(textToServer1,
